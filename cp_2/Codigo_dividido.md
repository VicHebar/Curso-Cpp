...
Hasta el momento hemos visto que los metodos de las clases también se pueden dividir en prototipos y definiciones, sin embargo sigue sin ser muy clara la utilidad de poder hacer esto, ya que el código sigue viéndose confuso y desordenado. Acontinuación veremos la utilidad de la misma.
...
# Comillas ("") en lugar de picoparéntesis (<>)
